/// A modified version of wordwrap from reflow, with support of iTerm2 proprietary image sequences.
/// The code is modified so it will never insert newlines in an iTerm2 image sequence.
